...
//Adapter utilizado pelo Recycler para criar a lista de carros
//Adapter deve inflar uma view (converter uma view em XML para objeto)
    ...
    public void onBindViewHolder(final CarrosViewHolder holder, final int position){
        ...
        Picasso.with(context).load(c.urlFoto).fit().into(holder.img, new com.squareup.picasso.Callback(){
            ...
            public void onSuccess(){
                //Donwload ok, então esconde progress
        ...
        if(carroOnClickListener != null){
            holder.itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    //Ao clicar na view da lista, chama a interface de callback (listenter)
